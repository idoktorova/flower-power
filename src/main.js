...
function importTypes(source) {
  try {
    ...
    normalizeData(); modal = null; toast = t('jsonImported'); render(); setTimeout(() => {toast = ''; render();},1800);
